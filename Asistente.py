...
class Ui_AsistenteRegistros(object):
    def setupUi(self, AsistenteRegistros):
        ...
        self.List_MReg.setGeometry(QtCore.QRect(400, 320, 241, 141))
        self.List_MReg.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.IBeamCursor))
        ...
        self.Label_hors.setGeometry(QtCore.QRect(230, 0, 181, 31))
        font = QtGui.QFont()
        ...
        self.Text_Reg = QtWidgets.QTextEdit(self.centralwidget)
        self.Text_Reg.setGeometry(QtCore.QRect(10, 340, 241, 31))
        self.Text_Reg.setObjectName("Text_Reg")
